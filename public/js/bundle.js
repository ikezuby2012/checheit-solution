...
function () {
  ...
  regeneratorRuntime.mark(function _callee(name, email) {
    var res, error, value, message, _message;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "thank you for subscribing to our newsletter");
            }
          ...
          case 9:
            ...
            if (error.code === 11000) {
              value = _context.t0.response.data.message.match(/(["'])(\\?.)*?\1/)[0];
              message = "duplicate field value ".concat(value, ". please provide another value");
              (0, _alerts.showAlert)("error", message);
            }

            if (error.errno === -3008) {
              _message = "thanks for your concern!";
              (0, _alerts.showAlert)("success", _message);
            }
...
var postBtn = document.querySelector(".form_labels");
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 5;
              return (0, _post.post)(name, email);
